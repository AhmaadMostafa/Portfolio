...
const WORDS = ["Hello, I'm Ahmed Mostafa"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ahmaadmostafa" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ahmed-mostafa-8093b4239/" }
];
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[3%] sm:px-4 lg:px-[2%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-8 lg:gap-12">
            {/* Left Column */}
            <div className="w-full lg:w-[45%] space-y-4 sm:space-y-6 text-left lg:text-left order-1 lg:order-1 lg:mt-0 lg:pr-0"
              data-aos="fade-right"
              data-aos-delay="200">
              <div className="space-y-3 sm:space-y-4 lg:pl-[15%]">
                <MainTitle />
